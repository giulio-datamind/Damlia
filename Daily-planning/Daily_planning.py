...
#This version finds a solution to the daily-planning problem by solving a satisfaction problem with a given maximum time limit for acceptable solutions.
...
def readInput(path_to_input_file):
    ...
    return [number_of_patients, number_of_operators, patient_costs]
...
[NUMBER_OF_PATIENTS, NUMBER_OF_OPERATORS, PATIENT_COSTS] = readInput(PATH_TO_INPUT)
